...
#import http.cookies (for parsing cookies)
#import http.cookiejar (for managing all the cookies stored in the browser)

class AdvCGI(object):
    header = 'Content-Type: text/html\n\n'
    url = '/cgi-bin/chapter10-cookies-multipart-multivalues.py'

    formhtml = '''<HTML><HEAD><TITLE>
cookies-multipart-multivalue demo</TITLE></HEAD>
